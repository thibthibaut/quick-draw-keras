'''
This script will automagically download all quickdraw dataset and skip already downloaded dataset
'''
import os
import subprocess
import numpy as np
